...
ventasCtrl.getProductos = (req, res) => {
  const sql = 'select p.*, c.codigoCategoria , c.descripcion as categoria from productos as p inner join categorias as c ON p.FK_codigoCategoria = c.codigoCategoria';
